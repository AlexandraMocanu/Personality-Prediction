// SOURCE CODE: https://codepen.io/wolthers/pen/LkOLQA
// RANGE SLIDER
...
// new RangeInput(document.querySelectorAll('.range'));

let ranges = document.querySelectorAll('.range');
Object.entries(ranges).map((object) => { new RangeInput(object[1]); });